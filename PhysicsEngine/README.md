...
![Minimum.Bounding.Box](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/Minimum_bounding_rectangle.svg/1024px-Minimum_bounding_rectangle.svg.png){: width="30%" height="30%"}
	- Sphere: 구
	- Convex hull: 볼록한 선체
![Convex.Hull](https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Extreme_points.svg/1024px-Extreme_points.svg.png){: width="30%" height="30%"}
